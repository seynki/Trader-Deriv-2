...
def fit_models_from_candles(candles: pd.DataFrame, cfg: MLConfig = CFG, horizon: int = 3, train_transformer: bool = True, transformer_epochs: int = 6, transformer_batch: int = 64) -> TrainedModels:
