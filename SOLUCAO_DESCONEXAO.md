...
- O arquivo `/frontend/.env` aponta para `https://deriv-ml-trader.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-ml-trader.preview.emergentagent.com`
- Backend API: `https://deriv-ml-trader.preview.emergentagent.com/api`
