...
- O arquivo `/frontend/.env` aponta para `https://derivbot-upgrade.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://derivbot-upgrade.preview.emergentagent.com`
- Backend API: `https://derivbot-upgrade.preview.emergentagent.com/api`
