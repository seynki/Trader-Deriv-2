...
- O arquivo `/frontend/.env` aponta para `https://symbol-trainer.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://symbol-trainer.preview.emergentagent.com`
- Backend API: `https://symbol-trainer.preview.emergentagent.com/api`
