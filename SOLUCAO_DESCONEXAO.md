...
- O arquivo `/frontend/.env` aponta para `https://trader-automation.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://trader-automation.preview.emergentagent.com`
- Backend API: `https://trader-automation.preview.emergentagent.com/api`
