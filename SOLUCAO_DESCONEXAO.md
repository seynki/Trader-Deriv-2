...
- O arquivo `/frontend/.env` aponta para `https://trade-assistant-28.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://trade-assistant-28.preview.emergentagent.com`
- Backend API: `https://trade-assistant-28.preview.emergentagent.com/api`
