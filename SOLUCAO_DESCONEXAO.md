...
- O arquivo `/frontend/.env` aponta para `https://market-signal-pro-2.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://market-signal-pro-2.preview.emergentagent.com`
- Backend API: `https://market-signal-pro-2.preview.emergentagent.com/api`
