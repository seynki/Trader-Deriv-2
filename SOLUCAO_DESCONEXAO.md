...
- O arquivo `/frontend/.env` aponta para `https://deriv-bot-finance.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-bot-finance.preview.emergentagent.com`
- Backend API: `https://deriv-bot-finance.preview.emergentagent.com/api`
