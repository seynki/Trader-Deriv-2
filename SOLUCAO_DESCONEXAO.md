...
- O arquivo `/frontend/.env` aponta para `https://finance-candle-ml.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://finance-candle-ml.preview.emergentagent.com`
- Backend API: `https://finance-candle-ml.preview.emergentagent.com/api`
