...
- O arquivo `/frontend/.env` aponta para `https://reconnect-aid.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://reconnect-aid.preview.emergentagent.com`
- Backend API: `https://reconnect-aid.preview.emergentagent.com/api`
