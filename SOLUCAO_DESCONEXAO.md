...
- O arquivo `/frontend/.env` aponta para `https://deriv-ml-candles.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-ml-candles.preview.emergentagent.com`
- Backend API: `https://deriv-ml-candles.preview.emergentagent.com/api`
