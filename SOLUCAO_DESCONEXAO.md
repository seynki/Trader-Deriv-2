...
- O arquivo `/frontend/.env` aponta para `https://smart-trade-robot-1.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://smart-trade-robot-1.preview.emergentagent.com`
- Backend API: `https://smart-trade-robot-1.preview.emergentagent.com/api`
