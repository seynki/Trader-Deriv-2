...
- O arquivo `/frontend/.env` aponta para `https://deriv-r10-bot.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-r10-bot.preview.emergentagent.com`
- Backend API: `https://deriv-r10-bot.preview.emergentagent.com/api`
