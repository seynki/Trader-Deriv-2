...
- O arquivo `/frontend/.env` aponta para `https://docker-debug-1.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://docker-debug-1.preview.emergentagent.com`
- Backend API: `https://docker-debug-1.preview.emergentagent.com/api`
