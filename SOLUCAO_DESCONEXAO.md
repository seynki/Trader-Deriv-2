...
- O arquivo `/frontend/.env` aponta para `https://market-ai-trader-8.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://market-ai-trader-8.preview.emergentagent.com`
- Backend API: `https://market-ai-trader-8.preview.emergentagent.com/api`
