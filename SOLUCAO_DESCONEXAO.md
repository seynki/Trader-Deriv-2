...
- O arquivo `/frontend/.env` aponta para `https://finance-candles-ml.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://finance-candles-ml.preview.emergentagent.com`
- Backend API: `https://finance-candles-ml.preview.emergentagent.com/api`
