...
- O arquivo `/frontend/.env` aponta para `https://hybrid-trade-algo.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://hybrid-trade-algo.preview.emergentagent.com`
- Backend API: `https://hybrid-trade-algo.preview.emergentagent.com/api`
