...
- O arquivo `/frontend/.env` aponta para `https://autotrader-deriv-1.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://autotrader-deriv-1.preview.emergentagent.com`
- Backend API: `https://autotrader-deriv-1.preview.emergentagent.com/api`
