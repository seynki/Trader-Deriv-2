...
- O arquivo `/frontend/.env` aponta para `https://deriv-connect-fix.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-connect-fix.preview.emergentagent.com`
- Backend API: `https://deriv-connect-fix.preview.emergentagent.com/api`
