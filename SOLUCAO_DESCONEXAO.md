...
- O arquivo `/frontend/.env` aponta para `https://mongodb-market-ai.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://mongodb-market-ai.preview.emergentagent.com`
- Backend API: `https://mongodb-market-ai.preview.emergentagent.com/api`
