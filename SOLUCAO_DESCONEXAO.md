...
- O arquivo `/frontend/.env` aponta para `https://finance-bot-4.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://finance-bot-4.preview.emergentagent.com`
- Backend API: `https://finance-bot-4.preview.emergentagent.com/api`
