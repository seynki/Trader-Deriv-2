...
- O arquivo `/frontend/.env` aponta para `https://model-trainer-repair.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://model-trainer-repair.preview.emergentagent.com`
- Backend API: `https://model-trainer-repair.preview.emergentagent.com/api`
