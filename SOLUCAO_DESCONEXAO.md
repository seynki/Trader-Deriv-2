...
- O arquivo `/frontend/.env` aponta para `https://market-bot-fix.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://market-bot-fix.preview.emergentagent.com`
- Backend API: `https://market-bot-fix.preview.emergentagent.com/api`
