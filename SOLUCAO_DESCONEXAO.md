...
- O arquivo `/frontend/.env` aponta para `https://finance-bot-timer.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://finance-bot-timer.preview.emergentagent.com`
- Backend API: `https://finance-bot-timer.preview.emergentagent.com/api`
