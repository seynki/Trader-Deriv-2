...
- O arquivo `/frontend/.env` aponta para `https://volatility-trader-2.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://volatility-trader-2.preview.emergentagent.com`
- Backend API: `https://volatility-trader-2.preview.emergentagent.com/api`
