...
- O arquivo `/frontend/.env` aponta para `https://finance-auto-robot.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://finance-auto-robot.preview.emergentagent.com`
- Backend API: `https://finance-auto-robot.preview.emergentagent.com/api`
