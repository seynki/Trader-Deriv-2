...
- O arquivo `/frontend/.env` aponta para `https://market-data-helper.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://market-data-helper.preview.emergentagent.com`
- Backend API: `https://market-data-helper.preview.emergentagent.com/api`
