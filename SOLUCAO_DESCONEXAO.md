...
- O arquivo `/frontend/.env` aponta para `https://trading-limit-check.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://trading-limit-check.preview.emergentagent.com`
- Backend API: `https://trading-limit-check.preview.emergentagent.com/api`
