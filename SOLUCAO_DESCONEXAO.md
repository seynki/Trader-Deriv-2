...
- O arquivo `/frontend/.env` aponta para `https://smart-deriv-bot-2.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://smart-deriv-bot-2.preview.emergentagent.com`
- Backend API: `https://smart-deriv-bot-2.preview.emergentagent.com/api`
