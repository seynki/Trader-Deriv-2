...
- O arquivo `/frontend/.env` aponta para `https://financebot-ml.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://financebot-ml.preview.emergentagent.com`
- Backend API: `https://financebot-ml.preview.emergentagent.com/api`
