...
- O arquivo `/frontend/.env` aponta para `https://finance-bot-timer-1.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://finance-bot-timer-1.preview.emergentagent.com`
- Backend API: `https://finance-bot-timer-1.preview.emergentagent.com/api`
