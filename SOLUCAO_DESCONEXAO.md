...
- O arquivo `/frontend/.env` aponta para `https://candles-ml-finance.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://candles-ml-finance.preview.emergentagent.com`
- Backend API: `https://candles-ml-finance.preview.emergentagent.com/api`
