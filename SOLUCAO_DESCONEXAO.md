...
- O arquivo `/frontend/.env` aponta para `https://market-bot-helper.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://market-bot-helper.preview.emergentagent.com`
- Backend API: `https://market-bot-helper.preview.emergentagent.com/api`
