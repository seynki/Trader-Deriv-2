...
- O arquivo `/frontend/.env` aponta para `https://backtest-optuna.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://backtest-optuna.preview.emergentagent.com`
- Backend API: `https://backtest-optuna.preview.emergentagent.com/api`
