...
- O arquivo `/frontend/.env` aponta para `https://websocket-error-fix-1.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://websocket-error-fix-1.preview.emergentagent.com`
- Backend API: `https://websocket-error-fix-1.preview.emergentagent.com/api`
