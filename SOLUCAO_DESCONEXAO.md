...
- O arquivo `/frontend/.env` aponta para `https://ml-preview-fix.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://ml-preview-fix.preview.emergentagent.com`
- Backend API: `https://ml-preview-fix.preview.emergentagent.com/api`
