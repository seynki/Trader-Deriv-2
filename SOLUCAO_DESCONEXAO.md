...
- O arquivo `/frontend/.env` aponta para `https://deriv-trading-bot-9.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-trading-bot-9.preview.emergentagent.com`
- Backend API: `https://deriv-trading-bot-9.preview.emergentagent.com/api`
