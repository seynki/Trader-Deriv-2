...
- O arquivo `/frontend/.env` aponta para `https://deriv-smartstop.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-smartstop.preview.emergentagent.com`
- Backend API: `https://deriv-smartstop.preview.emergentagent.com/api`
