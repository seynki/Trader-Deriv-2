...
- O arquivo `/frontend/.env` aponta para `https://trading-model-eval.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://trading-model-eval.preview.emergentagent.com`
- Backend API: `https://trading-model-eval.preview.emergentagent.com/api`
