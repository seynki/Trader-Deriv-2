...
- O arquivo `/frontend/.env` aponta para `https://deriv-trader-16.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-trader-16.preview.emergentagent.com`
- Backend API: `https://deriv-trader-16.preview.emergentagent.com/api`
