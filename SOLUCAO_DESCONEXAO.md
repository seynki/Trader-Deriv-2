...
- O arquivo `/frontend/.env` aponta para `https://stock-robot-fix.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://stock-robot-fix.preview.emergentagent.com`
- Backend API: `https://stock-robot-fix.preview.emergentagent.com/api`
