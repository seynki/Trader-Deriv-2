...
- O arquivo `/frontend/.env` aponta para `https://deriv-tradeai.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-tradeai.preview.emergentagent.com`
- Backend API: `https://deriv-tradeai.preview.emergentagent.com/api`
