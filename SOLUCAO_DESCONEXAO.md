...
- O arquivo `/frontend/.env` aponta para `https://deriv-autobot-1.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-autobot-1.preview.emergentagent.com`
- Backend API: `https://deriv-autobot-1.preview.emergentagent.com/api`
