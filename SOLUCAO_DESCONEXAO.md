...
- O arquivo `/frontend/.env` aponta para `https://autotrade-monitor.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://autotrade-monitor.preview.emergentagent.com`
- Backend API: `https://autotrade-monitor.preview.emergentagent.com/api`
