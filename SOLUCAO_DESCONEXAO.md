...
- O arquivo `/frontend/.env` aponta para `https://deriv-trade-bot-2.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-trade-bot-2.preview.emergentagent.com`
- Backend API: `https://deriv-trade-bot-2.preview.emergentagent.com/api`
