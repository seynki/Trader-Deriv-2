...
- O arquivo `/frontend/.env` aponta para `https://deriv-auto-trader.preview.emergentagent.com`  
...
### Produção (Emergent):
- Frontend: `https://deriv-auto-trader.preview.emergentagent.com`
- Backend API: `https://deriv-auto-trader.preview.emergentagent.com/api`
